...
const (
	...
	TodoService_PutTodo_FullMethodName        = "/todo.TodoService/PutTodo"
	TodoService_SetIsCompleted_FullMethodName = "/todo.TodoService/SetIsCompleted"
)
...
type TodoServiceClient interface {
	...
	SetIsCompleted(ctx context.Context, in *SetIsCompletedRequest, opts ...grpc.CallOption) (*Todo, error)
}
...
func (c *todoServiceClient) SetIsCompleted(ctx context.Context, in *SetIsCompletedRequest, opts ...grpc.CallOption) (*Todo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Todo)
	err := c.cc.Invoke(ctx, TodoService_SetIsCompleted_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TodoServiceServer interface {
	...
	SetIsCompleted(context.Context, *SetIsCompletedRequest) (*Todo, error)
...
func (UnimplementedTodoServiceServer) PutTodo(context.Context, *PutTodoRequest) (*PutTodoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PutTodo not implemented")
}
func (UnimplementedTodoServiceServer) SetIsCompleted(context.Context, *SetIsCompletedRequest) (*Todo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetIsCompleted not implemented")
}
...
func _TodoService_SetIsCompleted_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetIsCompletedRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TodoServiceServer).SetIsCompleted(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TodoService_SetIsCompleted_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TodoServiceServer).SetIsCompleted(ctx, req.(*SetIsCompletedRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TodoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetIsCompleted",
			Handler:    _TodoService_SetIsCompleted_Handler,
		},
	},
